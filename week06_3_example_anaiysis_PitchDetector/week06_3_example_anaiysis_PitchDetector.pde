//week06_3_example_anaiysis_PitchDetector
...
SoundFile sound;
PitchDetector pitchDetector;//宣告變數
int i;
...
void setup() {
  ...
  pitchDetector = new PitchDetector(this);//新增、初始化物件變數
  pitchDetector.input(sound);
  // capture audio input
  //pitchDetector.input(new AudioIn(this, 0));原本的程式，是用audio in音效卡的音源輸入
}
